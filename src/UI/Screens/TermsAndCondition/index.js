  ...
  return (
    ...
    <div role="status">
      ...
      <span class="sr-only">Loading...</span>
        ...
        <h1 class="mt-10 text-center text-3xl text-[#0059FF] font-bold">Privacy Policy</h1>
    <p class="m-5 p-5">Welcome to the marcos.com website (the “Site”) operated by Marcos LTD. We respect your privacy and want to protect your personal information. To learn more, please read this Privacy Policy.
    ...
    <p class="p-5 m-5"><span class="font-bold uppercase">Data that we collect: </span>We may collect various pieces of information if you seek to place an order for a product with us on the Site or App. We also collection few information when you chat with us on Facebook through Chrome Extension.
    ...
    <p class="p-5 m-5"><span class="font-bold uppercase">Other uses of your Personal Information: </span>We may use your personal information for opinion and market research. Your details are anonymous and will only be used for statistical purposes. You can choose to opt out of this at any time. Any answers to surveys or opinion polls we may ask you to complete will not be forwarded on to third parties. Disclosing your email address is only necessary if you would like to take part in competitions. We save the answers to our surveys separately from your email address.
    ...
    <p class="p-5 m-5"><span class="font-bold uppercase">Third Parties and Links: </span>We may pass your details to other companies in our group. We may also pass your details to our agents and subcontractors to help us with any of our uses of your data set out in our Privacy Policy. For example, we may use third parties to assist us with delivering products to you, to help us to collect payments from you, to analyze data and to provide us with marketing or customer service assistance.
